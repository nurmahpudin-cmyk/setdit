  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-xl md:text-2xl text-gray-900">Medical Trainees</h2>
          <p className="text-sm text-gray-600">Track and manage enrolled medical trainees across all branches</p>
        </div>
        <Button className="bg-teal-600 hover:bg-teal-700 self-start sm:self-auto">
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <Button variant="outline" className="sm:mt-6 self-end sm:self-auto">
