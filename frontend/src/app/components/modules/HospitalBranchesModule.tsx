  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-xl md:text-2xl text-gray-900">Hospital Branches</h2>
          <p className="text-sm text-gray-600">Manage multiple hospital locations under the consultancy network</p>
        </div>
