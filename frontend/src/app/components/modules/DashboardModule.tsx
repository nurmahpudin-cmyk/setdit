...
export function DashboardModule() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Message */}
      <div className="bg-gradient-to-r from-teal-600 to-blue-600 rounded-lg p-5 md:p-6 text-white">
        <h1 className="text-xl md:text-2xl mb-2">Welcome back, {userName}!</h1>
        <p className="text-sm text-teal-100">Here's a snapshot of your hospital training network.</p>
      </div>
